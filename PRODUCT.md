...
我拍｜開店平台（VOVOSnap）的目標用戶是「想快速上架商品，並擁有自己電商網站的人」：

- **剛開始賣東西的個人賣家**：想測試商品能不能賣，不想先花時間學習複雜的電商系統。
- **小型賣家 / 一人公司**：不想養工程師、不想學 Shopify，希望「拍照就能開店」。
- **需要大量上架商品的賣家**：商品更新速度快，希望縮短整理圖片、文案、規格與售價的時間；代購業者也是其中一種使用情境。

**Job-to-be-done**：把「我手上有商品」變成「我有自己的電商網站，可以讓客人下單」，中間繁瑣的上架、文案、規格與定價交給 AI 處理。

**核心痛點**：時間有限 + 上架繁瑣（不是手續費）。訴求是「效率提升 10 倍」。

## Product Purpose

讓任何想賣東西的人快速擁有自己的電商網站：
...
- **璀璨 AI startup（霓虹 / 漸層紫藍 + 光暈）** — 冷色調，跟個人賣家與小型品牌的使用情境錯配。
...
4. **給想快速開店的人，不給電商系統專家**：視覺語言應讓第一次賣東西的人感覺容易上手，不像 Shopify admin。
